              ...
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="hapus.php?id=<?=$data['id_pengunjung']; ?>" onclick ="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="btn btn-danger">Hapus</a> || <a href="editdatapengunjung.php?id=<?=$data["id_pengunjung"]; ?>" class="btn btn-warning">Ubah</a> || <a href="tambahdatapengunjung.php" class="btn btn-success">Tambah Data</a></td>
                  </tr>
                  <?php $n++; ?>
                  <?php endforeach; ?>  
                </tbody>
